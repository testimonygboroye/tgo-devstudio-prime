...
export const PAGE_DEFAULTS: Record<PageContentType, PageDefault> = {
  ...
  stack: {
    title: "Our Stack",
    content: "<p>Every technology choice on TGO DevStudio Prime was made deliberately, with real trade-offs considered.</p><h2>Framework</h2><p><strong>Next.js</strong> &mdash; chosen specifically for server-side rendering and static generation, which directly support fast page loads and strong SEO for a public-facing site.</p><h2>Database</h2><p><strong>MongoDB Atlas</strong> &mdash; a flexible, document-based database well suited to a content-heavy site with evolving data shapes across case studies, blog posts, and more.</p><h2>Media &amp; Assets</h2><p><strong>Cloudinary</strong> &mdash; handles all image, resume, and document uploads with automatic optimization and delivery.</p><h2>Email</h2><p><strong>Brevo</strong> &mdash; powers every transactional email on the site, from contact confirmations to admin notifications.</p><h2>Security</h2><p><strong>Cloudflare Turnstile</strong> &mdash; protects every public form from bots without forcing visitors through annoying puzzle challenges.</p><h2>Hosting</h2><p><strong>Render</strong> &mdash; auto-deploys directly from GitHub on every push, keeping the path from code to production simple and fast.</p><h2>Version Control</h2><p><strong>GitHub</strong> &mdash; every change to this site is tracked, reviewed, and deployed from a single source of truth.</p>"
  },
  "privacy-policy": {
