      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {teamMembers.map((member) => (
            <div key={member._id.toString()} className="rounded-xl border border-base-800 bg-base-900 p-6">
              {member.photo && (
              ...
              <p className="mt-3 text-center text-sm text-neutral-400">{member.bio}</p>
